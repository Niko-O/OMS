    ...
    Public Class SettingsProperty
        ...
        Public Sub New(NewSource As XElement)
            ...
            If _Type Is Nothing Then
                Throw New Exceptions.TypeNotFoundException(String.Format("Der Typ '{0}' der Eigenschaft {1} wurde nicht gefunden.", TypeName, _Name))
            End If
            _Converter = System.ComponentModel.TypeDescriptor.GetConverter(_Type)
            If _Converter Is Nothing Then
                Throw New Exceptions.TypeConverterNotFoundException(String.Format("Es wurde kein TypeConverter für die Konvertierung nach '{0}' gefunden.", _Type.AssemblyQualifiedName))
            End If
